...
public class Main {
    ...
    public static void main(String... strings) {
        int choice;
        do { // WHAT? WHAT IS THIS? PART 4? REALLY? YOU OVERACHIEVER YOU! YOU DID ALL 4 OF THE LOOPS!
            menu();
    ...
    /**
     * Used to select what choice in the main menu is picked.
     *
     *
     * @return int Returns whether the program should
     *///WOOOOOOT PART 1 OF REQ 4! ITS RIGHT HERE!
    ...
    //WOOTS PART 3 OF REQ 4! ITS ALL HERE TOPHER!
    private static void displayUpdateLogs() {
        File[] updates = getFilesFromFolder("Updates");
        //YO! ITS A ME! PART 3 OF REQUIREMENT 2!
        for (File f : updates) {
            try {
     ...
     */// WOOWZA! PART 2 DONE? FOR REQ 4? WE ARE CRUISING THROUGH THIS!
